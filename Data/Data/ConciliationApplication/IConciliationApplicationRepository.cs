...
{
    public interface IConciliationApplicationRepository
    {
        List<ConciliationApplicationModel> ConciliationList(ConciliationApplicationModel model);
        ConciliationApplicationModel AppliactionRecord(int ApplicationID);
        ConciliationApplicationModel SaveAppliactionRecord(ConciliationApplicationModel Obj);
