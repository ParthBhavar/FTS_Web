...
namespace FTS.Business
{
    public static class Utilities
    {
        ...
        /// <summary>
        /// Write text in bitmap image
        /// </summary>
        /// <param name="bitmapImg"></param>
        /// <param name="text"></param>
        /// <returns></returns>
        public static Bitmap WriteFooterTextInBitmap(Bitmap img, string leftText, string rightText)
        {
            int footerHeight = 100;
            Bitmap bitmapImg = new Bitmap(img);// Original Image
            Bitmap bitmapText = new Bitmap(img.Width, footerHeight);// Footer
            ...
            graphicImage.DrawImage(bitmapText, new Point(bitmapText.Width, 0));
            graphicImage.DrawString(leftText, new Font("Arial", 64), new SolidBrush(Color.Black), 60, bitmapImg.Height - (footerHeight / 2));
            graphicImage.DrawString(rightText, new Font("Arial", 64), new SolidBrush(Color.Black), img.Width - 500, bitmapImg.Height - (footerHeight / 2));
        ...
        /// <returns></returns>
        public static byte[] ConvertStreamToMemoryStream(Stream input)
        {
